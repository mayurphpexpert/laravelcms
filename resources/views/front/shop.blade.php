                    ...
                    <div class="card-body">
                        ...
                        @foreach ( $categories as $key => $category )
                            <div class="accordion-item">
                                ...
                                @if ( $category->subcategories->isNotEmpty())
                                <div id="collapseOne-{{$key}}" class="accordion-collapse collapse{{ ($categorySelected == $category->id) ? 'show' : '' }}" aria-labelledby="headingOne" data-bs-parent="#accordionExample-{{$key}}">
                                    <div class="accordion-body">
                                        <div class="navbar-nav">
                                            @foreach ($category->subcategories->where('showHome', 'Yes') as $subcategory)
                                            <a href="{{ route('shop.home',$subcategory->slug) }}" class="nav-item nav-link {{ ($categorySelected == $subcategory->id) ? 'text-primary' : '' }}">{{ $subcategory->name }}</a>
                                            @endforeach
                                        </div>                                        
                                    </div>
                                </div>
